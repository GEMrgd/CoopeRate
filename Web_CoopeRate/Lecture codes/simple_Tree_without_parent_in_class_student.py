...
def PreOrderTraversal(tree):
    ...
    if tree == None: 
        return []
    return [tree._element] + PreOrderTraversal(tree._left) + PreOrderTraversal(tree._right)
...
def PostOrderTraversal(tree):
    ...
    if tree == None: 
        return []
    return PostOrderTraversal(tree._left) + PostOrderTraversal(tree._right) + [tree._element]
    
def InOrderTraversal(tree):
    # base case
    if tree == None: 
        return []
    return InOrderTraversal(tree._left) + [tree._element] + InOrderTraversal(tree._right)
...
if __name__ == '__main__':
    ...
    ## TODO:
    three = TreeWithoutParent('3')
    two = TreeWithoutParent('2')
    five = TreeWithoutParent('5')
    twotwo = TreeWithoutParent('2')
    mul = TreeWithoutParent('*',three,two)
    minus = TreeWithoutParent('-',five,twotwo)
    tree = TreeWithoutParent('+',mul,minus)
